...
FaseDescrição**LEAD**Registro do contato inicial (ativo ou passivo)**QUALIFICAÇÃO**Análise de prioridade, validação de interesse + entrevista técnica**ELABORAÇÃO DE PROPOSTA**Formulário de cotação com dados pré-preenchidos da entrevista**PROPOSTA ENVIADA**Envio formal ao cliente, registro de data e responsável**NEGOCIAÇÃO**Histórico de interações, ajustes na proposta**FECHADO**Ganado (contrato/eventual formalizado) ou Perdido (com motivo)
